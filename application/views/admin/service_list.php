...
<head>
	...
	<script type="text/javascript" src="/resource/js/application/model/admin/service_list.js"></script>
	
	<script type="text/html" id="tpl-table-header">
		<th><div data-bind="text:service_id"></div></th>
		<th><div data-bind="text:service_name"></div></th>
		<th><div data-bind="text:controller"></div></th>
		<th><div data-bind="text:action"></div></th>
		<th><div data-bind="text:active"></div></th>
