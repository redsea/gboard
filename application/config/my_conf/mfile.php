...
// 이미지 파일 업로드 시 설정							
$config['supported_image_file_type'] = 'gif|jpg|png|jpeg|jpe';	// 이미지 파일 업로드시 받아 들일 수 있는 파일 타입
$config['supported_image_file_max_size'] = 2000;		// 업로드 된 파일의 최대 크기(KB 단위임)
$config['supported_image_file_max_width'] = 0;			// 업로드 된 파일의 최대 너비(픽셀 단위) 0 이면 제한 없음
$config['supported_image_file_max_height'] = 0;			// 업로드 된 파일의 최대 높이(픽셀 단위) 0 이면 제한 없음
