...
$config['oauth20_invalid_data_access_token']= 'E030008';		// access_token 발급시, api_key, api_secret, authorization_code 로 
																// authorization code 를 확인 할 수 없음.
...
$config['oauth20_invalid_data_refresh_token']='E030012';		// refresh token 을 위한 select 데이터 없음. api_key, api_secret, access_token 
																// 조합으로 select 하니 없음.
$config['oauth20_expired_access_token']		= 'E030013';		// expire 시간이 지나서 refresh token 을 요청 하였음.
																// 또는 유효 기간이 지난 access_token 으로 접근 하였음.
