...
$lang['E030008'] = '잘못된 요청 입니다.';						// access_token 발급시, api_key, api_secret, authorization_code 로 
...
$lang['E030012'] = '잘못된 요청 입니다.';						// refresh token 시을 위한 select 데이터 없음. api_key, api_secret, access_token 
															// 조합으로 select 하니 없음.
$lang['E030013'] = '이미 폐기된 access token 입니다';			// expire 시간이 지나서 refresh token 을 요청 하였음
$lang['E030014'] = 'access token 연장을 실패 했습니다';			// refresh token 실패(oauth20_code 테이블에 update 실패함)
?>